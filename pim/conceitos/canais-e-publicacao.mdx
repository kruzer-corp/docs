...
<CardGroup cols={2}>
  <Card title="Conteúdo por Canal" icon="arrows-split-up-and-left" href="/pim/conceitos/conteudo-por-canal">
    Atributos distintos por canal e fronteira de responsabilidade
  </Card>
