...
A Kruzer adota o modelo **RBAC** (*Role-Based Access Control*) para controlar quem pode fazer o quê dentro da plataforma. As permissões são geridas centralmente pelo IAM e valem para todos os módulos (DevTools, PIM, futuro OMS).
